...
/// </summary>
[ByRefEvent]
public readonly record struct EntityAshedBySupermatterEvent (EntityUid entity, EntityUid supermatterUid, SupermatterComponent supermatter, BaseContainer? container)
{
    /// <summary>
